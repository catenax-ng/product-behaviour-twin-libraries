...
public final class ResetDoc {
    public static final String SUMMARY = "Resets all info elements and clears vehicles and telematics data.";
    public static final String DESCRIPTION = """
The info elements are all deleted and reinitialized. They do not have to be initialized with the init endpoint.
""";

    public static final String RESPONSE_OK_DESCRIPTION = "OK: Reset successful.";
...
""";
    ...
    public static final String RESPONSE_ERROR_DESCRIPTION = "ERROR: Reset failed.";
