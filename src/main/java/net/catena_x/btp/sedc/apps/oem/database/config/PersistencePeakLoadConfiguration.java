package net.catena_x.btp.sedc.apps.oem.database.config;
...
@Configuration
@PropertySource({"classpath:peakloaddb.properties"})
@EnableTransactionManagement
@EnableJpaRepositories(
        basePackages = {PersistencePeakLoadConfiguration.BASE_PACKAGES},
        entityManagerFactoryRef = PersistencePeakLoadConfiguration.ENTITY_MANAGER_FACTORY,
        transactionManagerRef = PersistencePeakLoadConfiguration.TRANSACTION_MANAGER)
public class PersistencePeakLoadConfiguration {
    public static final String PREFIX = "peakload";
    public static final String CONFIG_PREFIX = "peakloaddb.";
    public static final String BASE_PACKAGES = "net.catena_x.btp.sedc.apps.oem.database.tables";
