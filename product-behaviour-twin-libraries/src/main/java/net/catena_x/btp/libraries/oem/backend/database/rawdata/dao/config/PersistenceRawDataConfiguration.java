...
@EnableJpaRepositories(
        basePackages = {PersistenceRawDataConfiguration.BASE_PACKAGES},
        entityManagerFactoryRef = PersistenceRawDataConfiguration.ENTITY_MANAGER_FACTORY,
        transactionManagerRef = PersistenceRawDataConfiguration.TRANSACTION_MANAGER)
public class PersistenceRawDataConfiguration {
    public static final String PREFIX = "rawdata";
    public static final String CONFIG_PREFIX = "rawdatadb.";
    public static final String BASE_PACKAGES = "net.catena_x.btp.libraries.oem.backend.database.rawdata.dao.tables";
